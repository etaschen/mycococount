#### Script pour lire et traiter les données brutes de comptage d'endomycorhizes
## Le fichier de données brutes est un fichier csv, séparateur ";"
## Il est supposé contenir un tableau
## Chaque ligne du tableau est un fragment de racine
## et il y a 4 colonnes : Echantillon : nom d'Echantillon de plante, Fragment: numéro de fragment, Infection (0,1,10,50,90 ou 100) et Richesse (0,1,2,3)
#Nom exact des Colonnes: Echantillon; Fragment; Infection; a_glo; v_glo;a_muc; Glomero; Mucoro


#### Se placer dans le répertoire qui contient le fichier de données brutes ####

##setwd("C:/Users/Taschen/Documents/all_inrae/INRA_EcoSols/DiAMs_ET/2024-2025")


#### Importer le fichier (indiquer le nom du fichier) ####

##tablo <- read.csv("AMF_MG_Philemon_Mai2024_test_MG.csv",sep=";")
tablo <- read.csv("AMF_Lucie_2025_R.csv",sep=";")
tablo <- na.omit(tablo)
